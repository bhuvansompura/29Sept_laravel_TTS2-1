<footer id="contact" class="container-fluid">
                  ...
                  <div class="col-lg-4 col-md-12 footer-form">
                       <div class="form-card">
                        ...
                        <div class="form-body">
                            ...
                            <button type="btn btn-sm btn-primary w-100" class="btn btn-danger">register</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo $baseURL; ?>assets/plugins/grid-gallery/js/grid-gallery.min.js"></script>
    <script src="<?php echo $baseURL; ?>assets/plugins/scroll-fixed/jquery-scrolltofixed-min.js"></script>
